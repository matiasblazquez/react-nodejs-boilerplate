...
[![Build Status](https://travis-ci.org/matiasblazquez/react-nodejs-boilerplate.svg?branch=master)](https://travis-ci.org/matiasblazquez/react-nodejs-boilerplate)

This is a boilerplate to build a full stack web application using React, Node.js, Express and Webpack. It is also configured with webpack-dev-server, eslint, prettier and babel.

- [react-nodejs-boilerplate](#react-nodejs-boilerplate)
...
Inspired in (https://github.com/crsandeep/simple-react-full-stack)
